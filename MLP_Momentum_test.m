...
momentum_options = [0.1 0.5 1]; % Define momentum options
count = length(momentum_options);
...
for i = 1 : count
    ...
    nn.momentum = momentum_options(i);
...
figure;
plot(momentum_options, my_train_error, momentum_options, my_test_error);
